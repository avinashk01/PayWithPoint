...
public class Resource_ProductControllerTest {
	 ...
	 * 
	 * 
	 * @Test public void test() throws Exception { HttpHeaders httpHeaders = new
	 * HttpHeaders(); httpHeaders.set("msgTs", "2019-06-09 11:00");
	 * httpHeaders.set("clientId", "1"); httpHeaders.set("channelId", "1");
	 * httpHeaders.set("correlationId", "586"); httpHeaders.set("svcName",
	 * "pwpservice"); httpHeaders.set("apiName", "getproductapi");
	 * httpHeaders.set("version", "v1"); httpHeaders.set("cvvNum", "895");
	 * httpHeaders.set("expDate", "2022-02-05"); httpHeaders.set("nameOnCard",
	 * "Denial"); RequestBuilder requestBuilder =
	 ...
	 * getContentAsString()); JSONAssert.assertEquals("",
